...
list contains an expression for the matrix (`mat_expr`). Hopefully, the example
below clarifies how these work.
...
If users are interested in exploring how altering constant vital rates alters
the way density dependence plays out, this is as simple as looping across the 
`make_data_list()` call and substituting in new values. 
